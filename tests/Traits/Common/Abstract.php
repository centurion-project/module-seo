<?php
/**
 * @class Seo_Test_Traits_Common_Abstract
 * @package Tests
 * @subpackage Seo
 * @author Richard Déloge, rd@octaveoctave.com
 *
 * Abstract class for all tests of Traits seo to generate the connection of the DB to use in this tests
 */
abstract class Seo_Test_Traits_Common_Abstract
    ...
    public function setUp() {
        ...
        Centurion_Db::getSingleton('seo/meta')->getCache()->clean();
    }
